...
//**************************************************************
svy: nbreg Home_health_days i.Composite_PPC_CAT i.YEAR ib3.Age_category ib2.SEX i.Marrital_status ib2.RACETHX ib3.Educat_WM ib3.REGION i.Income_status ib2.Employment_status ib2.Health_insurance_status ib3.Comorbidities ib2.Cancer_type_WM ib4.Cancer_tx_history_WM i.MNHLTH31_PER_MENTAL_HEALTH_STAT i.RTHLTH31_PER_HEALTH_STAT ib2.Smoking_status_WM i.Have_USC_Prov_WM if Home_health_days != -9
...
gen pos_visits = (Home_health_days > 0 & Home_health_days != -9) if !missing(Home_health_days)
...
svy: tnbreg Home_health_days i.Composite_PPC_CAT i.YEAR ib3.Age_category ib2.SEX i.Marrital_status ib2.RACETHX ib3.Educat_WM ib3.REGION i.Income_status ib2.Employment_status ib2.Health_insurance_status ib3.Comorbidities ib2.Cancer_type_WM ib4.Cancer_tx_history_WM i.MNHLTH31_PER_MENTAL_HEALTH_STAT i.RTHLTH31_PER_HEALTH_STAT ib2.Smoking_status_WM i.Have_USC_Prov_WM if pos_visits == 1 & Home_health_days != -9, ll(0)
estimates store h2
margins, dydx(i.Composite_PPC_CAT) predict(ir) post

// --- Combined Hurdle Model: Marginal Effects on E(Home_health_days) ---
suest h1 h2

// ereturn list

local hold "(invlogit(predict(eq(h1_pos_visits)))) * (exp(predict(eq(h2_Home_health_days)))) / (nbinomialtail(exp(-predict(eq(/h2:lnalpha))), 1, 1/(1+exp(predict(eq(h2_Home_health_days)))/exp(-predict(/h2:lnalpha)))))"

margins, dydx(i.Composite_PPC_CAT) expression("`hold'")
...
nbreg Home_health_days i.Composite_PPC_CAT i.YEAR ib3.Age_category ib2.SEX i.Marrital_status ib2.RACETHX ib3.Educat_WM ib3.REGION i.Income_status ib2.Employment_status ib2.Health_insurance_status ib3.Comorbidities ib2.Cancer_type_WM ib4.Cancer_tx_history_WM i.MNHLTH31_PER_MENTAL_HEALTH_STAT i.RTHLTH31_PER_HEALTH_STAT ib2.Smoking_status_WM i.Have_USC_Prov_WM 
scalar ll_NB  = e(ll)
...
capture drop pos_visits
gen byte pos_visits = (Home_health_days > 0) if Home_health_days < .
label var pos_visits "Had any office visits (1=Yes, 0=No)"

// Logistic part (Unweighted)
logit pos_visits i.Composite_PPC_CAT i.YEAR ib3.Age_category ib2.SEX i.Marrital_status ib2.RACETHX ib3.Educat_WM ib3.REGION i.Income_status ib2.Employment_status ib2.Health_insurance_status ib3.Comorbidities ib2.Cancer_type_WM ib4.Cancer_tx_history_WM i.MNHLTH31_PER_MENTAL_HEALTH_STAT i.RTHLTH31_PER_HEALTH_STAT ib2.Smoking_status_WM i.Have_USC_Prov_WM 
scalar ll_log = e(ll)
...
tnbreg Home_health_days i.Composite_PPC_CAT i.YEAR ib3.Age_category ib2.SEX i.Marrital_status ib2.RACETHX ib3.Educat_WM ib3.REGION i.Income_status ib2.Employment_status ib2.Health_insurance_status ib3.Comorbidities ib2.Cancer_type_WM ib4.Cancer_tx_history_WM i.MNHLTH31_PER_MENTAL_HEALTH_STAT i.RTHLTH31_PER_HEALTH_STAT ib2.Smoking_status_WM i.Have_USC_Prov_WM if pos_visits == 1
